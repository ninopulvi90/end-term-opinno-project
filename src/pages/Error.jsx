...
export default function Error(){
    return (
        <div className="container flex flex-col justify-center items-center w-screen h-screen ">
            ...
            <button className="rounded-2xl mt-10 bg-white text-black hover:bg-[#006793] hover:text-white border-solid border-2 border-black text-white font-bold py-2 px-4 rounded"><Link to="/">Home</Link></button>
